...
namespace MyMoridgeServer.BusinessLogic
{
    public class Booking
    {
        ...
        public void BookEvent(BookingEvent bookingEvent)
        {
            ...
            ev.Start = GoogleCalendarHelper.GetEventStart(bookingEvent.StartDateTime.AddHours(6)); //Compensate for timedifference between client- and serviceserver
            ev.End = GoogleCalendarHelper.GetEventEnd(bookingEvent.EndDateTime.AddHours(6)); //Compensate for timedifference between client- and serviceserver
